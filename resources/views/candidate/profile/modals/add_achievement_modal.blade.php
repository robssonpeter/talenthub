            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        ...
                        {{ Form::text('title', null, ['class' => 'form-control', 'id' => 'addAchievementTitle']) }}
                    </div>

                    <div class="form-group col-sm-12">
                        {{ Form::label('description', __('messages.common.description').':', ['class' => 'font-weight-bolder']) }}
                        {{ Form::textarea('description', null, ['class' => 'form-control', 'id' => 'addAchievementDescription', 'placeholder' => __('messages.candidate_profile.messages.what_achieved')]) }}
                    </div>
                </div>
