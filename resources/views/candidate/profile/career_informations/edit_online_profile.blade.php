...
<div class="text-right">
    {{ Form::button(__('messages.common.save'), ['type'=>'submit','class' => 'btn btn-primary','id'=>'btnOnlineProfileSave','data-loading-text'=>"<span class='spinner-border spinner-border-sm'></span> Processing..."]) }}
    <button type="button" id="btnOnlineProfileCancel"
            class="btn btn-light ml-1">{{ __('messages.common.cancel') }}</button>
</div>
{{ Form::close() }}
