...
@section('content')
    <section class="section">
        ...
        @include('staff.templates.templates')
    </section>
@endsection
@push('scripts')
    <script>
        let staffUrl = "{{ route('staff.index') }}";
    ...
    <script src="{{asset('assets/js/staff/staff.js')."?id=".\Illuminate\Support\Str::random(12)}}"></script>
@endpush
