  ...
  columns: [{
    ...
    name: 'id'
      ...
      data: function(row){
          ...
          //return '<span class="custom-switch-indicator"></span>';
      },
      name: 'is_active'
  }, {
    data: function data(row) {
...
$(document).on('click', '.custom-switch-input', function(){
    let plan = $(this).attr("data-id");
    let isChecked = $(this).prop('checked');
    let checkbox = $(this);
   //alert(isChecked);
    //$(this).prop('checked', !isChecked);
    $.ajax({
        url: planToggleUrl.replace('**id**', plan),
        type: 'POST',
        /*data: $(this).serialize(),*/
  ...
  $.ajax({
    ...
    success: function success(result) {
      if (result.success) {
        ...
        //$('#editSubscriptionDuration').val(result.data.subscription_duration);
        $('#editSubscriptionPeriod').val(result.data.subscription_period);
        $('#currency_edit').val(result.data.currency_id);
