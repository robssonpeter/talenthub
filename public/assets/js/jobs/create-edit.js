...
$(document).ready(function () {
  ...
  $('#salaryPeriodsId,#functionalAreaId,#requiredDegreeLevelId,#preferenceId,#jobCategoryId,#industries').select2({
    width: '100%'
  });
  $('#SkillId').select2({
    width: '100%',
  ...
  $('#details, #qualifications, #additional_information').summernote({
    minHeight: 200,
    toolbar: [['style', ['bold', 'italic', 'underline', 'clear']], ['font'], ['para', ['li', 'ol', 'ul','paragraph']]]
  });
...
$('#companyId').on('change', function(){
    let swapArea = document.getElementById('swapName');
    if(swapping[$(this).val()]){
        swapArea.classList.remove('d-none');
    }else{
        swapArea.classList.add('d-none');
    }
})
